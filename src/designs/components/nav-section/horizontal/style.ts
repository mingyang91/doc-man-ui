...
import { NAVBAR } from 'd/config'

// ----------------------------------------------------------------------

interface ListItemStylePrimitiveProps extends ButtonProps {
...
interface ListItemStyleLinkProps extends LinkProps {
...
interface ListItemStyleNavLinkProps extends NavLinkProps {
...
export type ListItemStyleProps =
  | ListItemStylePrimitiveProps
  | ListItemStyleLinkProps
  | ListItemStyleNavLinkProps
