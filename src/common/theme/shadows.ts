...
const createCustomShadow = (color: string) => {
  ...
  const shadowPosition = '0 0 1px 0 '
  ...
  return {
    ...
    //
    primary: `${shadowPosition}${alpha(palette.light.primary.main, 0.24)}`,
    info: `${shadowPosition}${alpha(palette.light.info.main, 0.24)}`,
    secondary: `${shadowPosition}${alpha(palette.light.secondary.main, 0.24)}`,
    success: `${shadowPosition}${alpha(palette.light.success.main, 0.24)}`,
    warning: `${shadowPosition}${alpha(palette.light.warning.main, 0.24)}`,
    error: `${shadowPosition}${alpha(palette.light.error.main, 0.24)}`,
    //
