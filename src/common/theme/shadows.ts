...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    //
    primary: `0 0 2px 4px${alpha(palette.light.primary.main, 0.24)}`,
    info: `0 0 2px 4px${alpha(palette.light.info.main, 0.24)}`,
    secondary: `0 0 2px 4px${alpha(palette.light.secondary.main, 0.24)}`,
    success: `0 0 2px 4px${alpha(palette.light.success.main, 0.24)}`,
    warning: `0 0 2px 4px${alpha(palette.light.warning.main, 0.24)}`,
    error: `0 0 2px 4px${alpha(palette.light.error.main, 0.24)}`,
    //
